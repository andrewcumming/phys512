...
- Join the **Slack** workspace for the class. You should have received email from the TA via myCourses (check your spam folder!).

- Fill out the **when2meet poll** that was sent in the same email so we can find a time for the **Debug den**.
...
It might be helpful to have a look at some NumPy tutorials to remind you how to create and manipulate arrays etc., and to remind yourself how to make a basic plot in Matplotlib if needed. The above links are to the documentation for each library, where you will find some basic introductory tutorials.  Otherwise, there are many tutorials you can find online. One place to look is at [Mike Zingale's class AST 390: Computational Astrophysics at Stonybrook](https://zingale.github.io/computational_astrophysics/intro.html)
...
A place to get started is the W3 Schools [git tutorial](https://www.w3schools.com/git/default.asp?remote=github). You can also look at the section on Github in [Mike Zingale's class AST 390: Computational Astrophysics at Stonybrook](https://zingale.github.io/computational_astrophysics/git/version-control.html) and the tutorials on Github, [Github quickstart](https://docs.github.com/en/get-started/quickstart/).
